...
{
    const RespirationArray = [{name:'Respirer pour …\ngagner en énergie',inspi:3,expi:2,type:0,round:36, destination:'Breath',apnée:0},{name:'Respirer pour …\nrécupérer',inspi:5,expi:10,type:1,round:5, destination:'Breath',apnée:20},{name:'Respirer pour …\ngérer son stress',inspi:3,expi:2,type:0,round:36, destination:'Breath',apnée:0},{name:'Personnaliser vos séances',inspi:1,expi:1,type:1,round:1, destination:'Personnalisée',apnée:0}];
    const render = ({item})=>{
