...
const ITEM_SIZE = 33;
const ITEM_SPACING = (width - ITEM_SIZE)/8;
export default function TimeChoice4({text, unité}) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.container2}>
          ...
          contentContainerStyle={{
            ...
            paddingHorizontal: ITEM_SPACING*1.5
          }}
          renderItem={({item, index})=>{
              ...
              return <View style={{width: 33, display:'flex',justifyContent:'center', alignItems:'center' }}>
